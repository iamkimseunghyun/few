...
- **버전:** 1.2
- **최종 수정일:** 2025년 7월 16일
- **변경 사항:** v1.1 대비 MVP 완성 및 프로덕션 배포 완료
...
## 6. 배포 정보 (Deployment Information)
...
### 6.2. 기술 스택 구현 현황
- **프론트엔드:** Next.js 15.3.5, React 19, TypeScript 5.7
- **스타일링:** Tailwind CSS v4 (Lightning CSS 통합)
- **백엔드:** tRPC v11 (App Router 통합)
- **데이터베이스:** PostgreSQL (Neon 서비스)
